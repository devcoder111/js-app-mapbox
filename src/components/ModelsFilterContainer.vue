      ...
      >
        <div style="padding-right: 20px">
          ...
          <a-select
            ...
            placeholder="From"
          >
            <a-select-option value="300000"> $300k </a-select-option>
            <a-select-option value="350000"> $350k </a-select-option>
            <a-select-option value="400000"> $400k </a-select-option>
            <a-select-option value="450000"> $450k </a-select-option>
            <a-select-option value="500000"> $500k </a-select-option>
            <a-select-option value="550000"> $550k </a-select-option>
            <a-select-option value="600000"> $600k </a-select-option>
            <a-select-option value="650000"> $650k </a-select-option>
          </a-select>
