  ...
  <div class="item">
    <div class="image-container">
      ...
      <div
        ...
        "
      >
        <div class="img-container" v-if="item.specification === 'evolve'">
          <img src="../assets/evolve.png" />
        </div>
        <div class="img-container" v-if="item.specification === 'advantage'">
          <img src="../assets/advantage.png" />
        </div>
      </div>
    </div>
    <div class="content">
    ...
    <div class="info-box">
      <div class="features">
        <div class="feature">
          <img src="../assets/home.png" alt="" width="24px" />
          {{ item.sq_ft }} sqft
        </div>
        <div class="feature">
          <img src="../assets/bed.png" alt="" width="24px" />
          {{ item.bedrooms }}
        </div>
        <div class="feature">
          <img src="../assets/bath.png" alt="" width="24px" />
          {{ item.bathrooms }}
        </div>
      </div>
      <div class="details">
        <a
          @click.prevent="openFloorplan()"
          :class="{
            disabled:
              item.floorplan_link === null || item.floorplan_link === '',
          }"
        >
        ...
        <a
          ...
          :class="{
            disabled: item.matterport === null || item.matterport === '',
          }"
        >
          View 3D Tour
        </a>
